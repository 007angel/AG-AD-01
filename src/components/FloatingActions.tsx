  ...
  return (
    <>
      <button
        type="button"
        onClick={onOpenQuote}
        className="fixed right-6 z-50 hidden md:inline-flex items-center justify-center rounded-full bg-emerald-500 px-5 py-3 text-sm font-semibold text-white shadow-xl shadow-emerald-500/30 transition hover:bg-emerald-400 bottom-[calc(max(1.5rem,env(safe-area-inset-bottom))+4.5rem)]"
      >
